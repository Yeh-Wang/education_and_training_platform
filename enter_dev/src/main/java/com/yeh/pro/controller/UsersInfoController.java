...
public class UsersInfoController {
     ...
     */
    @ResponseBody
    @GetMapping("/getUsersInfoByGrade/{user_grade}")
    List<UsersInfoEntity> getUsersInfoByGrade(@PathVariable int user_grade){
        return usersInfoService.getUsersInfoByGrade(user_grade);
    }

    /**
     * 根据机构编号和用户类型找到属于该机构的所有用户基本信息
     */
    @ResponseBody
